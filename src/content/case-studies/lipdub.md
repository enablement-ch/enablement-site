...
services:
  ...
  - HubSpot Attribution
challenge:
  title: Lipdub.ai had traction, but outbound was too manual to scale.
  intro: Lipdub.ai was already a fast-moving AI startup with real demand. They had a PLG motion, website traffic, outbound campaigns, and around $4M ARR, but their GTM motion was still hard to scale.
  paragraphs:
    - Lipdub.ai had a horizontal product that could serve video production teams, marketers, e-learning companies, creators, and media businesses. That created opportunity, but it also made GTM harder because the team needed to learn quickly which markets, personas, messages, and buying signals actually converted.
    - The team was doing a lot of outbound themselves. They were building lists in Apollo, testing different outbound tools, launching campaigns, and trying to connect results back into HubSpot. The process worked to a point, but it required too much coordination, setup, and manual effort.
    - The constraint was not a lack of activity. The constraint was focus and repeatability. Lipdub.ai needed a way to move quickly, learn quickly, and hone in on the right target market without building a large internal outbound team.
  bullets:
    - Manual list building created inconsistent outbound volume.
    - Multiple outbound tools made campaign execution harder to coordinate.
    - HubSpot attribution gaps made it difficult to connect campaigns to signups and pipeline.
    - The product served multiple ICPs, so the team needed fast market learning rather than generic email volume.
  keyLine: The outbound motion was active, but it was not yet a repeatable learning system.
  quote:
    text: "Before working with Enablement, we were doing a lot of outbound ourselves. The challenge was that we had 10,000 other things to do at the same time, and we needed a way to scale very quickly."
    attribution: Andrew
    detail: Lipdub.ai
solution:
  title: We turned outbound into a structured GTM testing system.
  paragraphs:
    - "We started by mapping Lipdub.ai's existing motion: their PLG flow, outbound setup, Apollo process, HubSpot attribution gaps, enterprise ICP hypothesis, and current campaign performance."
    - From there, we helped turn outbound into a structured testing system instead of a manual volume exercise. Campaigns were built around specific personas, markets, and buying signals so the team could learn which segments were worth scaling.
    - Messaging was tested and refined based on real responses, while reporting and attribution were improved so the team could understand where signups, meetings, and pipeline were coming from.
solutionSteps:
  - title: Map the existing GTM motion
    body: Understand the PLG funnel, outbound process, HubSpot setup, campaign performance, and ICP hypotheses before adding more activity.
  - title: Turn ICPs into campaign tests
    body: Build campaigns around specific personas, markets, and buying signals instead of broad horizontal outreach.
  - title: Refine messaging from real responses
    body: Use reply quality, meeting quality, and signup behavior to sharpen the message and identify the strongest segments.
